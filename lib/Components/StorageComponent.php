...
namespace Ttshop\Storage\Components;

use Ttshop\Storage\UploadedFile;
use Ttshop\Storage\Drivers\BaseDriver;

/**
 * Storage component
 *
 * @property \Ttshop\Drivers\BaseDriver $driver
...
class StorageComponent extends \yii\base\Component
{
    ...
    public function getDriver()
    {
        if ($this->driverInstance === null) {
            $this->setDriver([
                'class' => 'Ttshop\Storage\Drivers\Local'
            ]);
        }
